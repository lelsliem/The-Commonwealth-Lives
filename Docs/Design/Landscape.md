...
| **Settler & Companion Dialogue Overhaul** (41785) | 2,300+ new voiced lines for settlers, companions, enemies | **The audio path, later.** Our speech is captions now (post-0.9.0 audio is the plan); if we ever want *spoken* words, voiced settler lines exist to trigger. CK/asset territory — stays deferred. |
