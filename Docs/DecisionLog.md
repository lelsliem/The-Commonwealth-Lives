...
## 0062 — The dialog swap: the game's own lines, voice-aware silence (0.9.1a + 0.8.7, 2026-08-15)
...
lines recorded in MaleOld. The next stone (0.9.1b) triggers the
...
## 0063 — Voice-aware picking: ground truth from the BA2, not the catalog's counts (0.9.1b, 2026-08-15)

The 0.9.1a swap put the game's own lines in the subtitle layer; the
...
## 0063 addendum — the ghoul bank: shared lines, not a new register (0.9.1b)
